...
modelToUse_1 = 'backup/' + f'results_fold_{fold_k}_archi_1/' + 'current_model_epoch0.pt'
...
#% load the model to be tested
modelToUse_2 = 'backup/' + f'results_fold_{fold_k}_archi_2/' + 'current_model_epoch0.pt'
...
#% load the model to be tested
modelToUse_3 = 'backup/' + f'results_fold_{fold_k}_archi_3/' + 'current_model_epoch0.pt'

...
#        return 2
    ...
    def __getitem__(self,idx):
        ...
        sample = {'image1': currPatch1, 'image2': currPatch2, 'image3': currPatch3, 'labels': currLabel, 'candIdx' : idx} # return these values
...
LR = 5e-5
optimizer_1 = optim.Adam(model_1.parameters(),lr = 5e-6)
